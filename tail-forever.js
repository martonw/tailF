...
(function() {
  ...
  Tail = (function(superClass) {
    ...
    function Tail(filename, options) {
      ...
      if (this.options.syncCallback != null) {
        assert.ok(us.isFunction(this.options.syncCallback), "syncCallback should be function");
      }
      this.separator = (((ref = this.options) != null ? ref.separator : void 0) != null) || '\n';
      this.buffer = '';
      this.queue = new SeriesQueue(this._readBlock, this.options.syncCallback);
